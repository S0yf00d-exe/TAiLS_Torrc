...
_______________________________________ 
ExcludeEntry 14-Eyes + Japan, China,
Russia, Israel, Saudi Arabia, 
United Arab Emirates, Taiwan,
North Korea, and Unknown 
Country Nodes.
_______________________________________
...
echo "EntryNodes StrictNodes 1 (Every Country Except ExcludeNodes List)"

# EntryNodes StrictNodes 1 (Every Country Except EcludeNodes List)
...
echo 'ExcludeNodes {au},{ca},{nz},{gb},{fr},{jp},{cn},{ru},{il},{kp},{??}' | tee -a /etc/tor/torrc
